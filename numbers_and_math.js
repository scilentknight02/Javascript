...
console.log(Math.floor(4.6)) // Shows lower value even rounded value is upper
console.log(Math.ceil(4.1)) // Shows upper value even rounded value is lower

console.log()

console.log(Math.sqrt(64))
console.log(Math.min(3,8,5,9))
